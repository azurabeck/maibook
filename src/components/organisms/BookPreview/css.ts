...
export const bookPreviewCss = {
  trigger:'book-preview__trigger', overlay:'book-preview__overlay', topbar:'book-preview__topbar', title:'book-preview__title', close:'book-preview__close', viewport:'book-preview__viewport', book:'book-preview__book', page:'book-preview__page', header:'book-preview__header', content:'book-preview__content', pageNumber:'book-preview__page-number', chapterLabel:'book-preview__chapter-label', empty:'book-preview__empty',
} as const
